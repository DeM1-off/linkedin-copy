...
let samplePostData = PostData(id: 1, Image: "02", title: "Hitesh Choundary", followers: 5, profileImage: "1")
...
struct PostCardView: View {
    ...
    var body: some View {
        VStack(alignment: .leading)
        {
            ...
            Text("Looking for a new cource on IOs with swift UI, you are already at great place")
            Image(data.Image)
                .resizable()
                .aspectRatio(contentMode: .fit)
